...
<div class="nk-block nk-block-lg">
    <form action="{{ url('user/'.$user->id) }}" method="post" class="form-input">
        @csrf
        @method('put')
                    ...
                    <div class="card-inner">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" name="name" class="form-control @error('name') error @enderror" value="{{ old('name', $user->name) }}" placeholder="Please input name" required>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-control-wrap">
                                <input type="email" name="email" class="form-control @error('email') error @enderror" value="{{ old('email', $user->email) }}" placeholder="Please input email" required>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-control-wrap">
                                <input type="password" name="password" class="form-control @error('password') error @enderror" value="{{ old('password') }}" placeholder="Please input password">
                                        ...
                                        @foreach($roles as $role)
                                            <div class="col-sm-12 col-md-4">
                                                <div class="custom-control custom-radio ">
                                                    <input type="radio" id="reg-role-{{$role->id}}" name="role" class="custom-control-input" value="{{$role->id}}" {{ ($user->roles->first()->id == $role->id) ? 'checked' : '' }} required>
